...
namespace PerfRunner.Tests
{
   ...
   public class LoginPolly : TestBase
   {
      ...
      public LoginPolly(HttpClient httpClient, WebAppClient webApp, IUserManager userManager) : base(httpClient, webApp, userManager)
      {
         // _logger = logger;
         // _httpClient = httpClient;
      }
